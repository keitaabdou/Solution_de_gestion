...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-bold" style="font-size: 1.3em;"><b>Admin</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="#">Franponner par keita</a>.</strong> Tous les droits sont réservés.
  </footer>
